...
| :---------- | :----------------------: | :------------------------------ |
| status      |           bool           | The ETL response status         |
...
| indexed     |        bool        | Indexed status (optional).                  |
...
| itemsPerPageValue       |       int           | Items per page value.                    |
...
| isPaginationZeroBased   | bool (optional)     | Zero-based pagination flag (optional).   |
| isPaginationOffsetBased | bool (optional)     | Offset-based pagination flag (optional). |
...
| defaultValue | any (optional)                 | Default value (optional).     |
| ignoreEmpty  | bool (optional)                | Ignore empty (optional).      |
