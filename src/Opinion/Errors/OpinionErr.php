...
class OpinionErr
{
    ...
    public const FETCH_OPINION_I_GIVE_FAILED = 'opinion/fetch-i-give-failed';
    public const CREATE_OPINION_FORBIDDEN = 'opinion/creation-claim-forbidden';
    public const CREATE_OPINION_CLAIM_FORBIDDEN = 'opinion/creation-opinion-claim-forbidden';
    ...
    public static $errors = [
        ...
        self::FETCH_OPINION_I_GIVE_FAILED => 'Failed to fetch opinion i give',
        ...
        self::CREATE_OPINION_CLAIM_FORBIDDEN => 'Failed to create opinion claim forbidden',
